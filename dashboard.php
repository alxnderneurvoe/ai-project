...
<div cla ss="modal fade" id="updateConfirmModal" tabindex="-1" aria-hidden="true">
    <div cla ss="modal-dialog modal-dialog-centered">
        <div cla ss="modal-content bg-dark border-secondary text-white">
            <div class="modal-header border-secondary">
                <h5 class="modal-title">
    ...
    <div class="modal fade" id="deviceDetailModal" tabindex="-1" aria-hidden="true">
        <div cla ss="modal-dialog modal-lg modal-dialog-centered">
            <div cla ss="modal-content bg-dark border-secondary text-white">
                <div cla ss="modal-header border-secondary">
                    <h5 class="modal-title">
                ...
                <div cla ss="modal-body">
                    <div class="row g-4">
                        ...
                        <div cla ss="col-12">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <table c lass="table table-dark table-borderless mb-0">
                                        <tr>
                            ...
                            <div class="col-12">
                                ...
                                <div cla ss="card bg-secondary bg-opacity-10 border-secondary">
                        ...
                        <div cla ss="modal-footer border-secondary">
                    ...
                    <div cla ss="modal-dialog modal-lg modal-dialog-centered">
                        <div cla ss="modal-content bg-dark border-secondary text-white">
                            <div cla ss="modal-header border-secondary">
                                ...
                                <form id="deviceForm">
                                    <div class="modal-body">
                                        <inp ut type="hidden" id="deviceId" value="">
                                            <div cla ss="row gy-3">
                                                <div class="col-md-4">
                                                    <label class="form-label text-white-50">Serial Number (SN)</label>
                                                    <input type="text" id="deviceSN"
                                                        class="form-control form-control-lg" required>
                                                </div>
                                                <div class="col-md-4">
                                                    <label class="form-label text-white-50">No List</label>
                                                    <input type="text" id="deviceListing"
                                                        class="form-control form-control-lg">
                                                </div>
                                                <div class="col-md-4"></div>
                                                <div class="col-md-4">
                                                    <lab el class="form-label text-white-50">Type</label>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" id="deviceLaptop"
                                                                class="form-control form-control-lg">
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label class="form-label text-white-50">Brand</label>
                                                            <input type="text" id="deviceBrand"
                                                                class="form-control form-control-lg">
                                                            </di v>
                                                            <div class="col-md-4">
                                                                <label class="form-label text-white-50">CPU</label>
                                                                <input type="text" id="deviceCPU"
                                                                    class="form-control form-control-lg">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <lab el class="form-label text-white-50">RAM</label>
                                                                    <sel ect id="deviceRAM"
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <lab el class="form-label text-white-50">
                                                                                Storage</label>
                                                                                <sel ect id="deviceStorage"
                                                                                    class="form-select form-select-lg">
                                                                                    <option value="">Pilih Storage
                                                                                    </option>
                                                                                    <option value="">---------SSD
                                                                                        NVME---------</option>
                                                                                    <option value="64GB - SSD NVME">64GB
                                                                                        - SSD NVME</option>
                                                                                    <option value="128GB - SSD NVME">
                                                                                        128GB - SSD NVME</option>
                                                                                    <option value="256GB - SSD NVME">
                                                                                        256GB - SSD NVME</option>
                                                                                    <option value="512GB - SSD NVME">
                                                                                        512GB - SSD NVME</option>
                                                                                    <option value="1TB - SSD NVME">1TB -
                                                                                        SSD NVME</option>
                                                                                    <option value="">---------SSD
                                                                                        SATA---------</option>
                                                                                    <option value="64GB - SSD SATA">64GB
                                                                                        - SSD SATA</option>
                                                                                    <option value="128GB - SSD SATA">
                                                                                        128GB - SSD SATA</option>
                                                                                    <option value="256GB - SSD SATA">
                                                                                        256GB - SSD SATA</option>
                                                                                    <option value="512GB - SSD SATA">
                                                                                        512GB - SSD SATA</option>
                                                                                    <option value="1TB - SSD SATA">1TB -
                                                                                        SSD SATA</option>
                                                                                    <option value="">---------HDD
                                                                                        SATA---------</option>
                                                                                    <option value="64GB - HDD SATA">64GB
                                                                                        - HDD SATA</option>
                                                                                    <option value="128GB - HDD SATA">
                                                                                        128GB - HDD SATA</option>
                                                                                    <option value="256GB - HDD SATA">
                                                                                        256GB - HDD SATA</option>
                                                                                    <option value="512GB - HDD SATA">
                                                                                        512GB - HDD SATA</option>
                                                                                    <option value="1TB - HDD SATA">1TB -
                                                                                        HDD SATA</option>
                                                                                    </select>
                                                                                    </di v>
                                                                                    <div class="col-md-4">
                                                                                        <label
                                                                                            class="form-label text-white-50">Name</label>
                                                                                        <input type="text"
                                                                                            id="deviceName"
                                                                                            class="form-control form-control-lg">
                                                                                        </di v>
                                                                                        <div class="col-md-4">
                                                                                            <label
                                                                                                class="form-label text-white-50">Division</label>
                                                                                            <input type="text"
                                                                                                id="deviceDivision"
                                                                                                class="form-control form-control-lg">
                                                                                            </di v>
                                                                                            <div class="col-md-4">
                                                                                                <label
                                                                                                    class="form-label text-white-50">Status</label>
                                                                                                <input type="text"
                                                                                                    id="deviceStatus"
                                                                                                    class="form-control form-control-lg">
                                                                                            </div>
                                                                                            <div class="col-md-12">
                                                                                                <label
                                                                                                    class="form-label text-white-50">Spesifikasi</label>
                                                                                                <textarea
                                                                                                    id="deviceSpesifikasi"
                                                                                                    class="form-control form-control-lg"
                                                                                                    rows="3"></textarea>
                                                                                            </div>
                                                                                            </di v>
                                                                                            <div id="updateProcessing"
                                                                                                class="alert alert-info d-none d-flex align-items-center gap-2 mt-4"
                                                                                                role="status">
                                                                                                <i c
                                                                                                    lass="fas fa-circle-notch fa-spin"></i>
                                                                                                <div>
                                                                                                    <strong>Proses
                                                                                                        update</strong>
                                                                                                    <div
