                        ...
                        <div class="row g-3 mt-4">
                            ...
                            <div class="col-md-6">
                                <h6 class="text-warning mb-3">
                                    <i class="fas fa-microchip me-2"></i>Full Specification
                                </h6>
        ...
        <div class="modal-content bg-dark border-secondary text-white">
            <div class="modal-header border-secondary">
                <h5 class="modal-title" id="deviceModalTitle">
                    <i class="fas fa-plus me-2 text-primary"></i>Tambah Device
                </h5>
            ...
            <form id="deviceForm">
                <div class="modal-body">
                    ...
                    <div id="updateProcessing" class="alert alert-info d-none d-flex align-items-center gap-2 mt-4"
                        role="status">
